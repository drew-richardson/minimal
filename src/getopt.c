...
#define optarg dr_optarg
#define optind dr_optind
#define opterr dr_opterr
#define optopt dr_optopt
#define __optpos dr_optpos
#define optpos dr_optpos
#define __optreset dr_optreset
...
int getopt_long(int argc, char **argv, const char *optstring, const struct option *longopts, int *idx)
{
